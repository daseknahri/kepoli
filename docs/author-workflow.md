...
- If the writer saves a post that still has no Kepoli links inside the body, Kepoli can add a small in-content `Citeste si` paragraph automatically near the most relevant body paragraph, based on the strongest related posts.
